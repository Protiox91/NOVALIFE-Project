...
-- animal
RegisterNetEvent('NB:closeMenuAnimal')
AddEventHandler('NB:closeMenuAnimal', function()
	TriggerEvent('NB:closeAllMenu')
end)
...
-- accessoire
RegisterNetEvent('NB:closeMenuAccessory')
AddEventHandler('NB:closeMenuAccessory', function()
	TriggerEvent('NB:closeAllMenu')
end)
...
Citizen.CreateThread(function()
	while true do
		...
		(ESX.UI.Menu.IsOpen('default', 'eden_animal', 'pet_management')) or
		
		(ESX.UI.Menu.IsOpen('default', 'esx_accessories', 'set_unset')) or
