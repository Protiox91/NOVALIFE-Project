...
Config.Locale = 'fr'
Config.DeliveryTime = 1800                  --18000 -- IN SECOUNDS DEFAULT (18000) IS 5 HOURS / 300 MINUTES
...
Config.SellValue = 1.5 -- This is the shops value divided by 2
Config.ChangeNamePrice = 250 -- In $ - how much you can change the shops name for

-- CONFIG ITEMS, DON'T FORGET TO ADD CORRECT NUMBER IN THE BRACKETS
Config.Items = {
    [1] = {label = "Eau",       item = "water",        price = 1},
    [2] = {label = "Pain",      item = "bread",       price = 2},
    [3] = {label = "Téléphone",      item = "phone",       price = 110},
    [4] = {label = "Bouteille plongée -",      item = "plongee1",       price = 35},
    [5] = {label = "Bouteille plongée +",      item = "plongee2",       price = 65},
    [6] = {label = "Sac à Patates",      item = "blindfold",       price = 5},
    [7] = {label = "Voiture Télécommandée",      item = "rc",       price = 450},
    [8] = {label = "Ice Tea",      item = "icetea",       price = 3},
    [9] = {label = "Powerade",      item = "powerade",       price = 4},
    [10] = {label = "Jus de fruits",      item = "jusfruit",       price = 3},
    [11] = {label = "Limonade",      item = "limonade",       price = 2},
}
