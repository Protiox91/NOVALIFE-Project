...
Config.ReviveReward               = 450  -- revive reward, set to 0 if you don't want it enabled
...
Config.AuthorizedHelicopters = {
	...
	ambulance = {
		{ model = 'buzzard2', label = 'Ambulance Van', price = 2000}
	},

	doctor = {
		{ model = 'buzzard2', label = 'Nagasaki Buzzard', price = 3500 }
	},

	chief_doctor = {
		{ model = 'buzzard2', label = 'Nagasaki Buzzard', price = 4500 },
		{ model = 'seasparrow', label = 'Sea Sparrow', price = 7000 }
	},

	boss = {
		{ model = 'buzzard2', label = 'Nagasaki Buzzard', price = 150 },
		{ model = 'seasparrow', label = 'Sea Sparrow', price = 1100 }
	}
