...
function RespawnPed(ped, coords)
  ...
  esx.ShowNotification('Le contenus de vos poches vous a été rendu mais votre arme a été saisie pour des raisons de sécurité.')
  esx.ShowNotification('Des frais d\'Hospitalisation vous ont été prélevés, ils s\'élèvent à 1500$.')
