...
Config.PoliceStations = {
	...
	LSPD = {
		...
		Cloakrooms = {
			{ x = 452.600, y = -993.306, z = 29.800 },
		},
		
		Stocks = {
			{ x = 437.691, y = -991.346, z = 29.800 },
		},


		Armories = {
			{ x = 460.844, y = -982.201, z = 29.800 },
		},
		...
		Helicopters = {
			{
				Spawner    = { x = 464.558, y = -987.504, z = 43.691 },
...
Config.AuthorizedVehicles = {
	Shared = {
		{
			model = 'police',
			label = 'Police Patrouille'
		},
		{
			model = 'police2',
			label = 'Police Patrouille 2'
		},
		{
			model = 'police3',
			label = 'Patrouille Haute Vitesse'
		},
		{
			model = 'fbi',
			label = 'Banalisée'
