Locales['en'] = {
  ...
  ['box'] = 'box',
  ['cash'] = 'Box of cash',
  ['hitman_animations'] = 'Police Animations',
  ...
  ['alert_hitman'] = 'alert hitman',
  -- Authorized Vehicles
  ['hitman'] = 'Searching Vehicle 1',
  ['hitman2'] = 'Searching Vehicle 2',
  ['hitman3'] = 'Searching Vehicle 3',
  ['hitman'] = 'unmarked Vehicle',
  ['hitmanb'] = 'motorcycle',
  ['hitmant'] = 'transport Van',
}
