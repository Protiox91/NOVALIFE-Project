...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = -209.804, y = -1338.551, z = 33.894 },
	...
	Garage = {
		Pos   = { x = -225.598, y = -1321.4637, z = 29.890 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1,
	},
	...
	Craft = {
		Pos   = { x = -196.420, y = -1318.897, z = 30.089 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1,
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -187.935, y = -1290.355, z = 30.295 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
	},

	VehicleDeleter = {
		Pos   = { x = -191.217, y = -1284.373, z = 30.227 },
	...
	VehicleDelivery = {
		Pos   = { x = -166.439, y = -1306.101, z = 30.333 },
