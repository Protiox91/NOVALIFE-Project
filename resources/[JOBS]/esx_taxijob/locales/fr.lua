Locales['fr'] = {
  ...
  ['cloakroom_prompt'] = 'Appuie sur ~INPUT_CONTEXT~ to open the ~y~cloakroom~s~.',
  ['wear_citizen'] = 'citizen wear',
  ['wear_work'] = 'taxi wear',

  -- garage
  ['spawner_prompt'] = 'Appuie sur ~INPUT_CONTEXT~ to open the ~y~garage~s~.',
  ['store_veh'] = 'Appuie sur ~INPUT_CONTEXT~ pour ranger le véhicule',
  ...
  ['press_to_open'] = 'Appuie sur ~INPUT_CONTEXT~ pour accéder au menu.',
  ['billing'] = 'facuration',
