...
function checkSpeed()
    ...
    if mphspeed > maxspeed and driver == pP then
        ...
        advancednotify("CHAR_CALL911 ", 1, "Police 911", false, "Tu as été flashé pour excès de vitesse ! ~n~Pour le véhicule : " .. plate .. " ~n~Vitesse : "..mphspeed .."km/h ~n~Pour une route limitée a : ".. maxspeed .. "km/h ~n~Montant de l'amende : ".. Config.Fine .. "$")
    end
end
